 ...
 *
 * @details This class is responsible for storing, printing and comparing a
 * playing card.
 */
class Card {
     ...
     * @deprecated a card does not have mutable state neither the no argument constructor nor the set methods should be used
     */
    @Deprecated
    public Card() {
    }
    ...
    /**
     * This constructor should be preferred as a cards state isn't mutable. 
     * @param suit
     * @param value 
     */
    ...
    public boolean isEqual(Card rhs) {
    ...
    public boolean isLessThan(Card rhs) {
        return m_value.ordinal() < rhs.m_value.ordinal();
    }
    ...
    public boolean isLessThanOrEqual(Card rhs) {
        return m_value.ordinal() <= rhs.m_value.ordinal();
    }
    ...
    public boolean isGreaterThan(Card rhs) {
        return m_value.ordinal() > rhs.m_value.ordinal();
    }
    ...
    public boolean isGreaterThanOrEqual(Card rhs) {
        return m_value.ordinal() >= rhs.m_value.ordinal();
    }
    ...
    //NOTE: removed set_value, as a cards value should not be mutable
    //optionally could have markd both as @Deprecated as done with 
    //the no-arg constructor if the code is used as a client library 
    //clearly @Deprecated is correct otherwise removing the code outright 
    //would be correct
